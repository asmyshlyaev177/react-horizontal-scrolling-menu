...
const setup = (ratio = [0.3, 1, 0.7]) => {
  ...
  const nodes = observerEntriesToItems(newItems, { ratio: 0.5 })
  items.set(nodes)
...
describe('createApi', () => {
  ...
  describe('getItemById', () => {
    ...
    test('item not exist', () => {
      ...
      expect(createApi(items).getItemById('test123')).toEqual()
      expect(createApi(items).getItemById()).toEqual()
    })
  })
  ...
  describe('getItemByIndex', () => {
    test('item exist', () => {
      ...
      expect(createApi(items, visibleItems).getItemByIndex(0)).toEqual(nodes[0])
    })

    test('item not exist', () => {
      const { items } = setup([0.1, 1, 0.9])

      expect(createApi(items).getItemByIndex('5.1')).toEqual()
      expect(createApi(items).getItemByIndex()).toEqual()
    })
  })
  ...
  describe('getPrevItem', () => {
    ...
    test('do not have previous item', () => {
      ...
      expect(createApi(items, visibleItems).getPrevItem()).toEqual()
    })
  })
  ...
  describe('getNextItem', () => {
    ...
    test('do not have next item', () => {
      ...
      expect(createApi(items, visibleItems).getNextItem()).toEqual()
    })
  })
  ...
  describe('scrollToItem', () => {
    ...
    test('item not exists', () => {
      ...
      expect(() => createApi(items, visibleItems).scrollToItem()).not.toThrow()
    })
  })
