...
export const Route = createFileRoute('/$locale/examples/scroll-snap')({
  head: ({ params }) => {
    const locale = localeFromParam(params.locale);
    const copy = copyFor(locale?.code ?? 'en').examples['scroll-snap'];
    return pageHead({
      path: `/${params.locale}/examples/scroll-snap`,
