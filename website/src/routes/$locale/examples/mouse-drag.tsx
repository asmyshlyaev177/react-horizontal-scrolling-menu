...
export const Route = createFileRoute('/$locale/examples/mouse-drag')({
  head: ({ params }) => {
    const locale = localeFromParam(params.locale);
    const copy = copyFor(locale?.code ?? 'en').examples['mouse-drag'];
    return pageHead({
      path: `/${params.locale}/examples/mouse-drag`,
