...
// i18n:meta locale=pt-BR source=en/manifest.ts source-blob=4877f1ee74fa02f7ae1f9e695c0acaa73e4f6dfc status=translated
...
export const manifest: ManifestCopy = {
  ...
  examples: {
    ...
    'mui-scrollable-tabs': {
      name: 'Abas roláveis além do MUI',
      blurb:
        'Mantenha o contrato value/onChange do MUI; troque a faixa por baixo.',
    },
    'scroll-snap': {
      name: 'Carrossel com encaixe de rolagem',
      blurb:
        'Os cartões se encaixam no centro e se abrem em leque com CSS — sem motor de carrossel.',
    },
  },
};
