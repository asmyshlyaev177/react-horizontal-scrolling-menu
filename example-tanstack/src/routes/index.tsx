...
// NOTE: a 1:1 port of example-nextjs/app/page.tsx to TanStack Start with SSR.
// The e2e suite runs the same spec against both apps, so the DOM contract
// (data-cy, data-visible, 'Left'/'Right' arrows, card geometry) must match.
// The page is server-rendered in workerd on every request — the spec asserts
// the cards are already in the server HTML before hydration.
