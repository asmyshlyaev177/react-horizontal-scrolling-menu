import{n as e}from"./rolldown-runtime-DkW27tQK.js";var t;function n(){return(n=e((()=>{t=`{
  ...
  "scripts": {
    ...
    "install-example-tanstack-deps": "wireit"
  },
  "wireit": {
    "build-storybook": {
    ...
    "install-deps": {
      "command": "if [ -d node_modules/.pnpm ]; then pnpm install; else npm install; fi",
    ...
    "install-example-deps": {
      "command": "cd example-nextjs && if [ -d node_modules/.pnpm ]; then pnpm install; else npm install; fi",
      "dependencies": [
        "install-deps"
      ],
      "allowUsuallyExcludedPaths": true,
    ...
    "install-example-tanstack-deps": {
      "command": "cd example-tanstack && if [ -d node_modules/.pnpm ]; then pnpm install; else npm install; fi",
      "dependencies": [
        "install-deps"
      ],
      "allowUsuallyExcludedPaths": true,
      "clean": false,
      "files": [
        "example-tanstack/package.json"
      ],
      "output": [
        "example-tanstack/node_modules"
      ]
    },
    "serve-tanstack": {
      "command": "cd example-tanstack && npm run build && npm run serve",
      "service": true,
      "dependencies": [
        "build"
      ]
    ...
    "demo-tanstack": {
      "command": "cd example-tanstack && npm run dev",
      "service": true,
      "dependencies": [
        "dev"
      ]
