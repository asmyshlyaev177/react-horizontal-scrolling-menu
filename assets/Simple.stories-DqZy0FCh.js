...
`})))()}var F,I,L,R,z;function B(){return(B=t((()=>{n(),p(),d(),s(),h(),_(),M(),P(),F=r(),I={title:`Examples/Simple`,component:y,decorators:[e=>(0,F.jsx)(g,{children:(0,F.jsx)(e,{})})]},L={},m(L,{code:N,availableImports:l,modifyEditor:a}),R={...v(),tags:[`test-only`]},L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{}`,...L.parameters?.docs?.source}}},R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  ...ScrollTest(),
  tags: ['test-only']
}`,...R.parameters?.docs?.source}}},z=[`Simple`,`Test`]})))()}B();export{L as Simple,R as Test,z as __namedExportsOrder,I as default};